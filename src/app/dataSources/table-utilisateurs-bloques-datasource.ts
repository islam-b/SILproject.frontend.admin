...
/**
 * Data source for the TableUtilisateursBloques view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class TableUtilisateursBloquesDataSource extends DataSource<UtilisateurFabricant> {
